...
Sage 9 with UIKit, custom templates for pages, hard code templates and select in WP-Admin (leave page blank), decent size footer. Switch different header in app.blade, one for front page and one for the rest.
...
Uses css and js files rather than npm imports as its a custom theme is taken from UIkit website and is not in NPM.
